...
def eval_seq(
        ...
        result_jsonl_filename, save_dir=None,
...
def main(opt, data_root, seqs, exp_name: str, result_root: str,
    ...
    for seq in seqs:
        ...
        os.makedirs(os.path.dirname(result_jsonl_filename), exist_ok=True)

        nf, ta, tc = eval_seq(
            opt, dataloader, data_type, result_filename,
            result_jsonl_filename, save_dir=output_dir,
...
if __name__ == '__main__':
    ...
    main(_opt,
         ...
         seqs=_seqs,
         exp_name=_opt.exp_id,
         result_root=str(data_dir / "experiments" / _opt.exp_id),
         show_image=False,
         save_images=False,
         save_videos=False)
